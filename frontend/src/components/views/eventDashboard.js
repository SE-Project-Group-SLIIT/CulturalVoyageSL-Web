  ...
  return (
    ...
    <Container>
      ...
      <h1 style={{fontFamily:'Roboto',marginTop:'25px'}}>Celebrate traditions, embrace heritage</h1><h3 style={{fontFamily:'Montserrat'}}>Discover our events.</h3>
        <Col >
            <Row style={{marginTop:'5px',marginBottom:'25px',justifyContent:'space-between',paddingLeft:'70px',paddingRight:'70px'}}>
            <Card
      border="primary"
      style={{ width: '9rem', transition: 'transform .2s', transform: transformStyle }}
      onMouseEnter={() => { setTransformStyle('scale(1.1)') }}
      onMouseLeave={() => { setTransformStyle('scale(1)') }}
    >
        ...
        <Card.Body>
          <Card.Title style={{fontSize:'12px',color:'#0d6efd'}}>Religious</Card.Title>
          <Card.Text>
          <img src="images/religions.png" 
        style={{width: '100%'}}
         alt="events" />
      ...
      <Card
      border="info"
      style={{ width: '9rem', transition: 'transform .2s', transform: transformStyle1 }}
      onMouseEnter={() => { setTransformStyle1('scale(1.1)') }}
      onMouseLeave={() => { setTransformStyle1('scale(1)') }}
    >
        <Card.Body>
        <Card.Title style={{fontSize:'12px',color:'#0dcaf0'}}>Festivals</Card.Title>
          <Card.Text>
      ...
      <Card
      border="success"
      style={{ width: '9rem', transition: 'transform .2s', transform: transformStyle2 }}
      onMouseEnter={() => { setTransformStyle2('scale(1.1)') }}
      onMouseLeave={() => { setTransformStyle2('scale(1)') }}
    >
        <Card.Body>
        <Card.Title style={{fontSize:'12px',color:'#198754'}}>Exibitions</Card.Title>
          <Card.Text>
          <img src="images/exibition.png" 
        style={{width: '100%'}}
         alt="events" />
          </Card.Text>
        </Card.Body>
      ...
      <Card
      border="danger"
      style={{ width: '9rem', transition: 'transform .2s', transform: transformStyle3 }}
      onMouseEnter={() => { setTransformStyle3('scale(1.1)') }}
      onMouseLeave={() => { setTransformStyle3('scale(1)') }}
    >
        <Card.Body>
        <Card.Title style={{fontSize:'12px',color:'#dc3545'}}>Entertains</Card.Title>
          <Card.Text>
      ...
      <Card
      border="warning"
      style={{ width: '9rem', transition: 'transform .2s', transform: transformStyle4 }}
      onMouseEnter={() => { setTransformStyle4('scale(1.1)') }}
      onMouseLeave={() => { setTransformStyle4('scale(1)') }}
    >
        <Card.Body>
      ...
      <Row style={{marginTop:'25px',marginBottom:'25px',backgroundColor:'ghostwhite' ,padding:'25px',borderRadius:'20px'}}>
        ...
        <Col style={{fontFamily:'Montserrat',justifyContent:'center',lineHeight:'80%'}}>
        <hr></hr>
          <p><h5>"Stay up-to-date with the latest cultural events in Sri Lanka with our event calendar. Never miss a festival, exhibition, or conference again! Our calendar is a one-stop-shop for all your event needs, providing you with a comprehensive guide to the exciting events taking place throughout the country. Browse by date or event type, and find the perfect cultural experience to enrich your life and expand your horizons. Discover the rich tapestry of Sri Lankan culture through our event calendar today."</h5></p>
        <hr></hr>
        <br></br><br></br>
